...
// salesforce_helper.go provides HTTP helpers for Salesforce requests, handling
// auth failures (401/403), rate limiting (429 with Retry-After), and
// header-signaled auth problems on 200 OK responses.
